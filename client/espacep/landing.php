...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="../CODE/index.html">Initiation au code</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link " data-toggle="modal" data-target="#change_password" >Changer le mot de passe  </a>
              </li>
              <li class="nav-item">
